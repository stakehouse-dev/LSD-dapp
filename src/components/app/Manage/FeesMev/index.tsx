...
import { useCustomAccount, useNetworkBasedLinkFactories, usePortfolioFeesMev } from '@/hooks'
import { humanReadableAddress } from '@/utils/global'

import Stats from './Stats'

export const FeesMev = () => {
    ...
    <div className="max-w-7xl w-full mx-auto flex flex-col items-center justify-center gap-4 py-8 text-grey25">
      ...
      <div className="flex gap-4 mb-6 w-full justify-center">
        {data && (
          <ActionButton
            ...
            href={makeEtherscanTrackerLink(
              `token/${data.giantFeesAndMevPools[0].giantLPToken}?a=${address}`
            )}
            target="_blank">
        ...
        <ActionButton
          className="px-3"
          onClick={() =>
            window.open(`/graphql-playground/${WITHDRAW_MODE.FEES_MEV}/${address}`, '_blank')
          }>
